AFRAME.registerComponent("spawn-text", {
  ...
  init: function () {
    ...
    text.setAttribute("position", "0 2.4 0");
    text.setAttribute("visible", false);
    text.setAttribute("geometry", "primitive: plane; width: 7; height: 0.5");
    text.setAttribute(
      "material",
      "color: black; opacity: 0.7; side: double; transparent: true; metalness: 0.5; roughness: 0.5"
    );
